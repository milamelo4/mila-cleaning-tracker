    ...
    <div className="space-y-5">
      ...
      <section className="rounded-3xl border border-[var(--border-soft)] bg-[var(--card)] p-5 shadow-sm">
        ...
        <div className="mt-4 rounded-2xl bg-[var(--cream)] p-4">
          <div className="flex items-start gap-3">
            <KeyRound
              size={20}
              className="mt-0.5 text-[var(--blue)]"
            />
      ...
      <section className="rounded-3xl border border-[var(--border-soft)] bg-[var(--card)] p-5 shadow-sm">
        ...
        <p className="mt-2 text-sm text-[var(--muted)]">
          Private — helpers cannot see these
          notes.
        </p>

        <div className="mt-4 rounded-2xl bg-[var(--cream)] p-4">
          <p className="whitespace-pre-line font-semibold text-[var(--charcoal)]">
            {adminNotes ||
      ...
      <section className="rounded-3xl border border-[var(--border-soft)] bg-[var(--card)] p-5 shadow-sm">
        ...
        <p className="mt-2 text-sm text-[var(--muted)]">
          Private — use this for raises and
          pricing history.
        </p>
      ...
      <section className="rounded-3xl border border-[var(--border-soft)] bg-[var(--card)] p-5 shadow-sm">
        ...
        <p className="mt-2 text-sm text-[var(--muted)]">
          Visible to helpers assigned to this
          client's cleanings.
        </p>
        ...
        <div className="mt-4 rounded-2xl bg-[var(--cream)] p-4">
          <p className="whitespace-pre-line font-semibold text-[var(--charcoal)]">
            {cleaningInstructions ||
              "No cleaning instructions added"}
          </p>
        </div>
      </section>
      ...
      {role === "admin" && (
        <div className="mt-6 flex gap-3">
          <button
            onClick={() =>
              navigate(
                `/clients/${client.firestoreId}/edit`
              )
            }
